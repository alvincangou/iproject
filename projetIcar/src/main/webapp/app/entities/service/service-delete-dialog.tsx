...
export const ServiceDeleteDialog = (props: IServiceDeleteDialogProps) => {
  ...
  const confirmDelete = () => {
    props.deleteEntity(props.serviceEntity.id);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="icarApp.service.delete.question">
        <Translate contentKey="icarApp.service.delete.question" interpolate={{ id: serviceEntity.id }}>
